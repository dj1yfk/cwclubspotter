...
<head>
        ...
        <title>rbn.telegraphy.de - Informationen zum Datenschutz / Data Privacy and Security Information</title>
    <style>
p {
    max-width: 50em;
    text-align: justify;
...
Diese Seite stellt aufgearbeitete Daten aus dem "Reverse Beacon Network", einem Netzwerk
...
<p>This website offers services for radio amateurs, specifically real-time data that was received by the Reverse Beacon Network, an international network of SDR receivers with Morse- and digital mode decoders, in an easy to read format. The processing of this data is based on legitimate interests in accordance with the GDPR (47).</p>
