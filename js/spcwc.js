...
function stripcall (c) {
	...
	function update_table () {
			...
			var newtable;
			newtable = '<table class="tab" id="spots">' + '<tr><th class="myth">Frequency</th><th class="myth">Call</th><th class="myth">Age</th><th class="myth">Clubs</th><th  class="myth" style="width:45px">WPM</th><th class="myth">Spotted by (and signal strength)</th></tr>';
