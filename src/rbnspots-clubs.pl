...
my @clubs = qw/CWOPS FISTS FOC HSC VHSC SHSC EHSC SKCC AGCW NAQCC BUG RCWC LIDS NRR QRPARCI CWJF TORCW SOC UFT ECWARC LICW EACW MF A1C NTC MORSE 4SQRP 30CW/;
my %bm = ();
